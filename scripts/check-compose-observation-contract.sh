...
readonly compose_format='{{.Label "com.docker.compose.project"}}	{{.Label "com.docker.compose.service"}}	{{.Label "com.docker.compose.oneoff"}}	{{.State}}	{{.HealthStatus}}'
...
expected="$(printf 'contract-project\tcontract-service\tFalse\tcreated\t')"
