use pharos_core::{
    ...
    HOST_REPORT_V5_SCHEMA, HOST_REPORT_V5_VERSION, HOST_REPORT_V6_SCHEMA, HOST_REPORT_V6_VERSION,
    HOST_REPORT_VERSION, MAX_HOST_REPORT_BYTES, PREVIOUS_HOST_REPORT_SCHEMA,
    PREVIOUS_HOST_REPORT_VERSION, SUPPORTED_HOST_REPORT_CONTRACTS,
};
...
fn control_plane_accepts_current_and_previous_reports_for_ordered_rollouts() {
    ...
    assert_eq!(PREVIOUS_HOST_REPORT_SCHEMA, HOST_REPORT_V6_SCHEMA);
    assert_eq!(PREVIOUS_HOST_REPORT_VERSION, HOST_REPORT_V6_VERSION);
    assert_eq!(HOST_REPORT_V4_VERSION + 1, HOST_REPORT_V5_VERSION);
    assert_eq!(HOST_REPORT_V5_VERSION + 1, HOST_REPORT_V6_VERSION);
