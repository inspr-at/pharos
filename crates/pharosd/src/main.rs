...
.top:before{content:"";position:absolute;left:0;right:-16%;top:-76px;height:310px;background:url('/assets/fleet-horizon.png') right center/auto 224px no-repeat;opacity:.86;pointer-events:none;-webkit-mask-image:radial-gradient(ellipse at 73% 46%,#000 0 24%,rgba(0,0,0,.82) 37%,rgba(0,0,0,.34) 58%,transparent 80%);mask-image:radial-gradient(ellipse at 73% 46%,#000 0 24%,rgba(0,0,0,.82) 37%,rgba(0,0,0,.34) 58%,transparent 80%)}
